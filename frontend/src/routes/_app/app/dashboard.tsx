...
function StatStrip({
  ...
  const items = [
    { label: "Open matches", value: stats.total },
    { label: "Strong fits", value: stats.strong },
    { label: "Closing in 7 days", value: stats.closing },
...
function EmailDeliveryNudge() {
  ...
  if ((recipients.data ?? []).some((r) => r.verified_at && !r.unsubscribed_at)) {
    return null
  }
